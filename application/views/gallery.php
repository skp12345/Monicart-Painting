...
<section id="primary" class="content-full-width">
    <div class="fullwidth-section">
        <div class="container">
            <div class="main-title mt-5" data-animation="pullDown" data-delay="100">
                <h3>Gallery</h3>
                            ...
                            <figcaption>
                                <div class="portfolio-detail">
                                    ...
                                    <div class="portfolio-title">
                                        <h5><a href="<?php echo base_url() ?>single?url=<?php echo $images->img_id  ;?>"><?php echo $images->title;?></a></h5>
