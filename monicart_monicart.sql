...
--
-- Host: localhost:3306
-- Generation Time: Jun 24, 2023 at 03:33 PM
...
(1, 'monicart@gmail.com', 'monicart123@');
...
(32, 'Key of success in life', ' I designed 3 contemporary abstract portrait in this painting. Each portrait has different meaning of success in life. \r\n\r\nThe success of key is saying we have to keep growing in all the area of life, whether it\'s mental, emotional, spiritual.\r\nKey of success in our hands only, no matter how many hurdles come in life, we have to take it as a challenges and keep moving to achieve success.', 'InShot_20230213_180513056.jpg', '27', 1, '2023-02-14 19:55:32'),
(33, 'Abstract contemporary art with graphite pencil', 'Art has the power to heal people. It can harness the healing power within each of us and helps in bringing us together as a community. The artwork connects us to the artist. \r\n\r\nIn this painting  you will see different types of art form like reading books, speaking, music, visual art. \r\nAll this art form is therapy  that keeps our mind, body and soul in balance. \r\n\r\nBooks helps us to understand the effect that all these things have on us and our world, Books have potential in healing and helps u', 'WhatsApp_Image_2023-04-15_at_14_20_32.jpg', '27', 1, '2023-04-15 16:09:56'),
(34, 'Celebration', 'Let\'s celebrate, the most valuable thing is not associated with money, it\'s moments which makes memories, don\'t let them go. Cherish those moments. \r\nYour moments of togetherness, be it music, be it games, it does create those moments. Embracing those moments allow us to pause, reflect & express gratitude. Finding solace in the present & hope for the future. ', 'IMG_20230523_164801.jpg', '27', 1, '2023-05-23 18:52:08');
...
--
ALTER TABLE `images`
  MODIFY `img_id` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;
